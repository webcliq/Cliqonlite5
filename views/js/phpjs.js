...
/* is_array */
;function is_array(t){var e,o,s;return _isArray=function(t){if(!t||"object"!=typeof t||"number"!=typeof t.length)return!1;var e=t.length;return t[t.length]="bogus",e!==t.length?(t.length-=1,!0):(delete t[t.length],!1)},!(!t||"object"!=typeof t)&&(this.php_js=this.php_js||{},this.php_js.ini=this.php_js.ini||{},e=this.php_js.ini["phpjs.objectsAsArrays"],_isArray(t)||(!e||0!==parseInt(e.local_value,10)&&(!e.local_value.toLowerCase||"off"!==e.local_value.toLowerCase()))&&"[object Object]"===Object.prototype.toString.call(t)&&"Object"===(o=t.constructor,(s=/\W*function\s+([\w\$]+)\s*\(/.exec(o))?s[1]:"(Anonymous)"))}

 ...
 * @version    SVN: $Id: arz.php 2800 2019-03-18 07:56:11Z translatewiki $
 */
...
$err_passwd_empty = ' كلمه السر غير صحيحه. أعد المحاولة';
$alt_delete = 'ءازاله  الرسا ئل المختارة';
$alt_delete_one = 'ءازاله الرسالة';
$alt_new_msg = 'رساله جديدة';
$alt_reply = 'ءاجاابه المرسل';
$alt_reply_all = 'ءاجاابه للجميع';
$alt_forward = 'تحويل';
$alt_next = 'اللى بعد كده';
$alt_prev = 'اللى قبل كده';
$title_next_page = 'الصفحه التالية';
$title_prev_page = 'الصفحه السابقة';
$title_next_msg = 'التالية';
$title_prev_msg = 'السابقة';
$html_theme_label = 'السمة:';
$html_welcome = 'مرحبا إلى %1$s';
$html_login = 'تسجيل الدخول';
$html_submit = 'ءارسال';
$html_help = 'مساعدة';
$html_wrong = 'ءأسم المستخدم أو كلمه السر غير صحيحة';
$html_retry = 'المحاوله تانى';
$html_remember = 'تذكر الإعدادات';
$html_lang_label = 'اللغة:';
$html_msgperpage_label = 'الرسائل لكل صفحة:';
$html_preferences = 'تفضيلات';
...
$html_signature = 'توقيع';
$html_signature_label = 'التوقيع:';
$html_prefs_updated = 'حُدّثت التفضيلات';
...
$html_send_html_mail = 'أرسل البريد بهيئه HTML';
$html_folders = 'مجلدات';
...
$html_folder_rename = 'إعاده تسمية';
...
$html_attach = 'ءاضافة';
$html_attach_forget = '!يجب ءاضافه الملف قبل ءارسال الرسالة';
$html_attach_delete = 'ءازاله الملفات المختارة';
$html_attach_none = 'يجب أن تختار ملفا للإرفاق!';
$html_sort_by = 'مرتبه حسب';
$html_sort = 'رتب';
$html_from = 'من';
$html_from_label = 'من:';
...
$html_send = 'أرسل';
$html_cancel = 'الغى';
$html_no_mail = 'ليست هناك أيه رسالة';
$html_logout = 'خروج';
$html_msg = 'رسالة';
$html_msgs = 'رسائل';
...
$html_contact_list = 'قائمه معارف %1$s';
$html_contact_del = 'من قائمه المراسلين';
$html_contact_err1 = 'أقصى عدد للمراسلين هو "%1$d"';
$html_contact_err2 = 'لا تستطيع إضافه مراسل جديد';
$html_contact_err3 = 'لا تمتلك صلاحيات الوصول إلى قائمه المراسلين';
...
$html_images_warning = 'لأسباب أمنيه، الصور البعيده غير معروضه.';
...
$html_invalid_email_address = 'عنوان بريد إلكترونى غير صحيح';
$html_invalid_msg_per_page = 'عدد رسائل لكل صفحه غير صحيح';

 ...
 * @version    SVN: $Id: cs.php 2749 2018-02-12 07:38:56Z translatewiki $
 */
/** Czech (čeština)
 * 
...
$html_lang_label = 'Jazyk:';
$html_msgperpage_label = 'Zpráv na stránku:';
...
$html_reply_leadin_label = 'Hlavička odpovědi:';
...
$html_sent_folder_label = 'Kopírovat odeslané dopisy do vyhrazené složky:';
$html_trash_folder_label = 'Přesunout smazané dopisy do vyhrazené složky:';
...
$html_filter_moveto = 'Přesunout do';
...
$html_subject_label = 'Předmět:';
$html_date = 'Datum';
$html_date_label = 'Datum:';
$html_sent_label = 'Odesláno:';
$html_wrote = 'napsal(a)';
$html_size = 'Velikost';
...
$html_spam = 'Spam';
$html_spam_warning = 'Tato zpráva byla identifikována jako spam.';
...
$html_contact_count = '%1$d kontakty';
$html_contact_err1 = 'Maximální počet kontaktů je %1$d';
$html_contact_err2 = 'Nemůžete přidat nový kontakt.';
$html_contact_err3 = 'Nemáte přístup k seznamu kontaktů';
$html_contact_none = 'Nenalezeny žádné kontakty.';
...
$lang_err_send_delay = 'Musíte počkat %1$d sekund před odesláním dalšího dopisu';
$html_search = 'Hledat';

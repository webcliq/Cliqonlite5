 ...
 * @version    SVN: $Id: pt-br.php 2767 2018-08-06 05:26:38Z translatewiki $
 */
...
$html_contact_err1 = 'Máximo número de contatos é "%1$d"';
...
$html_contact_ruler_top = 'Acima';
$html_contact_listcheck_title = 'Verificar para marcar e-mail à lista.';
$html_contact_list_add = 'Adicionar à lista';
$html_contact_listname = 'Nome da lista';
$html_contact_listonly = 'Somente listas';
$html_contact_all = 'Mostrar todos';
$html_contact_add_confirm = 'Anexas e-mails à lista existente?';
...
$html_search = 'Buscar';
$html_new_session = 'Nova sessão';
$html_fd_filename = 'Baixar %1$s';
$html_fd_mailcount = '{{PLURAL:$1|0=Não há mensagens|1=Há %1$d mensagem|Há %1$d mensagens}} na pasta.';
$html_fd_mailskip = 'As seguintes mensagens não farão parte do arquivo mbox porque excedem o valor «memory_limit» de PHP:';
...
$html_send_recover = 'Entre para recuperar o rascunho perdido!';
$html_send_discard = 'Clique aqui para ignorar o rascunho guardado.';
$html_collect_label = 'Recolher automaticamente os endereços de e-mail:';
$html_collect_option0 = 'Nunca';
$html_collect_option1 = 'Somente e-mail enviados';
$html_collect_option2 = 'Somente e-mail abertos';
$html_collect_option3 = 'Sempre';
$html_version_message1 = 'Estamos usando a versão mais recente';

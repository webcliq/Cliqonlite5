 ...
 * @version    SVN: $Id: fr.php 2833 2019-11-04 15:00:48Z translatewiki $
 */
/** French (français)
 * 
...
$html_remember = 'Se souvenir de moi';
$html_lang_label = 'Langue :';
$html_msgperpage_label = 'Messages par page :';
$html_preferences = 'Préférences';
$html_full_name_label = 'Nom complet :';
$html_email_address_label = 'Adresse de courriel :';
$html_bccself = 'Recevoir une copie cachée';
$html_hide_addresses = 'Cacher les adresses';
$html_outlook_quoting = 'Citation de style Outlook';
...
$html_reply_leadin_label = 'Entête de réponse :';
$html_prefs_updated = 'Les préférences ont été mises à jour';
$html_manage_folders_link = 'Gestion des dossiers IMAP';
$html_manage_filters_link = 'Gestion des filtres d’adresses de courriel';
$html_use_graphical_smilies = 'Utiliser les émoticônes graphiques';
$html_sent_folder_label = 'Copier les courriels envoyés dans un dossier dédié :';
$html_trash_folder_label = 'Déplacer les courriels effacés dans un dossier dédié :';
$html_inbox_folder_label = 'Connecter l’entrée de menu « Boîte de réception » au répertoire :';
...
$html_filter_subject = 'Objet du message';
$html_filter_to = 'Champ À';
$html_filter_cc = 'Champs Copie à';
$html_filter_from = 'Champs De';
$html_filter_change_tip = 'Pour changer un filtre, réécrivez simplement dessus.';
$html_reapply_filters = 'Réappliquer tous les filtres';
$html_filter_contains = 'contient';
$html_filter_name = 'Nom du filtre';
$html_filter_action = 'Action du filtre';
$html_filter_moveto = 'Déplacer vers';
$html_select_one = '--Sélectionner un--';
$html_and = 'Et';
$html_new_msg_in = 'Nouveaux messages dans';
$html_or = 'ou';
$html_move = 'Déplacer';
$html_copy = 'Copier';
$html_messages_to = 'les messages sélectionnés vers';
...
$html_from_label = 'De :';
$html_subject = 'Sujet';
$html_subject_label = 'Objet :';
$html_date = 'Date';
$html_date_label = 'Date :';
$html_sent_label = 'Envoyé le :';
$html_wrote = 'a écrit';
$html_quote_wrote = 'Le %1$s à %2$s, %3$s a écrit :';
$html_size = 'Taille';
...
$html_to_label = 'À :';
$html_cc = 'Copie à';
$html_cc_label = 'Copie à :';
$html_bcc_label = 'Copie cachée à :';
$html_nosubject = 'Aucun sujet';
$html_send = 'Envoyer';
$html_cancel = 'Annuler';
$html_no_mail = 'Aucun message.';
$html_logout = 'Se déconnecter';
$html_msg = 'Message';
$html_msgs = 'Messages';
$html_configuration = 'Ce serveur n’est pas correctement configuré !';
$html_priority = 'Priorité';
$html_priority_label = 'Priorité :';
...
$html_flagged = 'Marqué';
$html_spam = 'Pourriel';
$html_spam_warning = 'Ce message a été classé comme pourriel.';
$html_receipt = 'Demander un accusé de réception';
$html_select = 'Sélectionner';
$html_select_all = 'Inverser la sélection';
$html_select_contacts = 'Sélectionner des contacts';
$html_loading_image = 'Chargement de l’image';
$html_send_confirmed = 'Votre courriel a été accepté pour l’envoi';
$html_no_sendaction = 'Aucune action spécifiée. Essayer d’activer JavaScript.';
$html_error_occurred = 'Une erreur est survenue';
$html_prefs_file_error = 'Impossible d’ouvrir le fichier de préférences en écriture.';
$html_wrap = 'Nombre de caractères au delà duquel les lignes de messages sortants doivent être repliées :';
$html_wrap_none = 'Pas de repliement de ligne.';
$html_usenet_separator = 'Séparateur Usenet (« -- \n ») avant la signature';
$html_mark_as = 'Marquer comme';
$html_read = 'lu';
$html_unread = 'non lu';
$html_encoding_label = 'Encodage du texte :';
$html_add = 'Ajouter';
...
$html_contact_err1 = 'Le nombre maximal de contacts est « %1$d »';
...
$html_contact_ruler_top = 'Haut';
$html_contact_listcheck_title = 'Cocher pour ajouter le courriel à la liste.';
$html_contact_list_add = 'Ajouter à la liste';
$html_contact_listname = 'Nom de la liste';
$html_contact_listonly = 'Les listes uniquement';
$html_contact_all = 'Afficher tout';
$html_contact_add_confirm = 'Ajouter les courriels à la liste existante ?';
...
$html_smtp_error_no_conn = 'Impossible d’ouvrir la connexion SMTP';
$html_smtp_error_unexpected = 'Réponse SMTP inattendue :';
$lang_could_not_connect = 'Impossible de se connecter au serveur';
$lang_invalid_msg_num = 'Mauvais numéro de message';
$html_file_upload_attack = 'Possibilité d’attaque par fichier téléversé';
$html_invalid_email_address = 'Adresse courriel invalide';
$html_invalid_msg_per_page = 'Nombre non valide de messages par page';
$html_invalid_wrap_msg = 'Largeur de repliement des lignes non valide';
$html_seperate_msg_win = 'Messages dans des fenêtres séparées';
$html_err_file_contacts = 'Impossible d’ouvrir le fichier des contacts en écriture.';
$html_session_file_error = 'Impossible d’ouvrir le fichier des sessions en écriture.';
$html_login_not_allowed = 'Cet identifiant n’est pas autorisé à se connecter.';
$lang_err_send_delay = 'Vous devez attendre entre deux courriels (%1$d secondes)';
$html_search = 'Rechercher';
$html_new_session = 'Session suivante';
$html_fd_filename = 'Télécharger %1$s';
$html_fd_mailcount = 'Il {{PLURAL:$1|0=n’y a aucun courriel|1=Il y a %1$d courriel|y a %1$d courriels}} dans le dossier.';
$html_fd_mailskip = 'Les courriels suivants ne feront pas partie du fichier mbox, car ils dépassent la valeur de « memory_limit » de PHP :';
$html_fd_filesize = 'taille %1$d';
$html_fd_skipcount = 'avec %1$d courriels';
$html_fd_largefolder = 'Selon votre vitesse de téléchargement, ce téléchargement peut échouer à cause d’un dépassement de durée d’exécution du script.<br /> Veuillez vérifier si votre téléchargement est complet ou fixer « max_execution_time » à une valeur supérieure dans « php.ini ».';
$reset_clicked = 'Voulez-vous vraiment effacer ce formulaire ?';
$html_send_recover = 'Se connecter pour récupérer le brouillon perdu !';
$html_send_discard = 'Cliquer ici pour ignorer le brouillon enregistré.';
$html_collect_label = 'Collecter automatiquement les adresses de courriel :';
$html_collect_option0 = 'Jamais';
$html_collect_option1 = 'Seulement pour les courriels sortants';
$html_collect_option2 = 'Seulement pour les courriels ouverts';
$html_collect_option3 = 'Toujours';
$html_version_message1 = 'Nous utilisons la dernière version';
$html_version_message2 = 'La dernière version n’a pas pu être récupérée';
$html_version_message3 = 'Une nouvelle version est disponible';
$html_session_expired = 'Cette session est expirée';
$html_session_ip_changed = 'du fait d’une modification de l’adresse IP du client';
$html_session_expire_time = 'Cette session expirera automatiquement à';
$html_inbox_changed = 'Le contenu de votre boîte de réception a été modifié';

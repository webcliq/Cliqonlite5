<!-- start of $Id: send.php 2713 2017-09-06 12:34:03Z oheil $ -->
<?php
...
<form id="sendform" enctype="<?php echo (ini_get("file_uploads")) ? "multipart/form-data" : "normal" ?>" method="post" onsubmit="return(validate(this));" action="send.php?<?php echo NOCC_Session::getUrlGetSession();?>">
...
?>
	...
	?>
     <tr>
       <td>&nbsp;</td>
       <td class="sendData">
         <?php if (!NOCC_Session::getSendHtmlMail() || !file_exists('ckeditor.php')) { ?>
...
function validate(f) 
{
	...
	confirm("<?php echo $reset_clicked ?>");
	if( retVal == false ) {
		return false;
	}
    }
...
<!-- end of $Id: send.php 2713 2017-09-06 12:34:03Z oheil $ -->

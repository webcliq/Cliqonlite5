...
class Html 
{
	...
	public static $stag = [
		'link', 'meta', 'input', 'file', 'img', 'br', 'hr', 'wbr', 'embed'
	];
	...
	public static $tag = [
		...
		'summary', 'time', 'track', 'video', 'dialog', 'draggable', 'droppable', 
		// Form Element
		'form', 'button', 'fieldset', 'legend', 'textarea', 'select', 'optgroup', 'option', 'label', 'small', 'error', 'required',
		// To do checkbox, file, radio, select etc.	
		// Vue Template Components
		'FullCalendar', 'BootstrapTable', 'template'
	];
